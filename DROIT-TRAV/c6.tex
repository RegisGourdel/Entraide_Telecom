...
L'indemnité légale ne peut pas être inférieure à 1/5\up{e} d'un mois de salaire multiplié par le nombre d'années d'ancienneté. Au-delà de 10 ans d'ancienneté, il faut y ajouter 2/15e d'un mois de salaire par année supplémentaire. Le calcul de l'indemnité prend également en compte l'année en cours.
