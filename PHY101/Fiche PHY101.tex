...
\newcommand\psib{\mid \psi \rangle}
\newcommand\psibp{\mid \psi ' \rangle}

% Commande qui change la police
\renewcommand*\rmdefault{ppl}

% Titre de la fiche
\title{\vspace{-1.2cm} Fiche de PHY101}
\date{}
...
\section{Matériaux semi-conducteur}

	\input{semiConducteurs.tex}
