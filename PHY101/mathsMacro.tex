...
\newcommand\li{[\![}
\newcommand\ri{]\!]}
\newcommand{\diff}{\mathop{}\mathopen{}\mathrm{d}} % Le d de dx ou dt dans les intégrales
\newcommand{\abs}[1]{\left\lvert#1\right\rvert} % Valeur absolue
\newcommand{\norme}[1]{\left\lVert#1\right\rVert}
\newcommand{\transp}[1]{{#1}^{\mathsf{T}}} % Transposée
\newcommand{\scal}[2]{\left\langle #1 \mid #2 \right\rangle} % Produit scalaire
\newcommand\Hom{\mathrm{Hom}}
\newcommand\End{\mathrm{End}}
\newcommand\Isom{\mathrm{Isom}}
\newcommand\Aut{\mathrm{Aut}}
\newcommand\Int{\mathrm{Int}}
\newcommand{\compl}[1]{{#1}^{\mathcal{C}}} % Complémentaire d'un ensemble
\newcommand\indep{\protect\mathpalette{\protect\independenT}{\perp}} % Variables aléatoires indépendantes
