...
\newcommand{\poly}{\ensemblenombre{P}} % Espace de polynômes
...
\DeclareMathOperator{\WN}{WN} % Weak white noise
\DeclareMathOperator{\IID}{IID} % Strong white noise
\DeclareMathOperator{\Jac}{Jac} % Matrice jacobienne
\DeclareMathOperator{\alg}{alg} % Clôture algébrique
\DeclareMathOperator{\divg}{div} % Opérateur divergence ou diviseur en courbes algébriques
\DeclareMathOperator{\Frac}{Frac} % Corps des fractions d'un anneau
\DeclareMathOperator{\degtr}{deg. tr}
\DeclareMathOperator{\Frob}{Frob} % Frobenius
\DeclareMathOperator{\Gal}{Gal} % Groupe de Galois
\DeclareMathOperator{\sep}{sep} % Clôture séparable
\DeclareMathOperator{\Fix}{Fix} % Ensemble des points fixes
\DeclareMathOperator{\Div}{Div} % Groupe des diviseurs sur une courbe
\DeclareMathOperator{\Pic}{Pic} % Groupe de Picard
